...
public class RiskRegisterController {
    ...
    @GetMapping("/all")
    public ResponseEntity<?> getAllRiskRegisters(
        ...
        return ResponseEntity.ok(
            ...
            riskRegisterService
                .getAllRiskRegisters(pageable)
                .getContent()
        );
    }

    @GetMapping("/{id}")
    public ResponseEntity<RiskRegisterResponse>
    getRiskRegisterById(
